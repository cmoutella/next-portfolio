const texts = {
  ...
  career: {
    ...
    highlights: {
      ...
      list: [
        "Developed solutions for platforms with over 300K users",
        ...
        "Took part of estrategic actions to improve platform's SEO",
        ...
        "Organized codebase for landing pages components",
      ],
    },
    skills: {
